...
EOF
    ...
    # --- QEMU NETWORK FLAGS CHANGED HERE (e1000 Driver) ---
    echo "Run: qemu-system-aarch64 -M virt -cpu cortex-a53 -nographic -kernel bzImage-arm -initrd initramfs.cpio.gz -append \"console=ttyAMA0 init=/init\" -m 256M -netdev user,id=net0 -device e1000,netdev=net0"
fi
